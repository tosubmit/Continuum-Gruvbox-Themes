...
<td width="320" style="vertical-align:top; padding-right:32px;">
  <img src="screenshots/gruvbox-deep-dark.png" width="300" alt="Gruvbox Deep Dark" style="border-radius:12px; box-shadow: 0 0 20px rgba(251,241,199,0.15);" />
</td>
...
<div align="right" style="margin-top:16px;">
  <a href="./Gruvbox_Deep_Dark.json">
    <img src="https://img.shields.io/badge/Copy_Theme-121212?style=for-the-badge&logo=clipboard&logoColor=EBDBB2&labelColor=1A1A1A&color=1A1A1A&border=1" alt="Copy Dark Theme" style="transition: transform 0.2s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'" />
  </a>
</div>
...
<tr>
<td width="320" style="vertical-align:top; padding-right:32px;">
  <img src="screenshots/gruvbox-deep-light.png" width="300" alt="Gruvbox Deep Light" style="border-radius:12px; box-shadow: 0 0 20px rgba(40,40,40,0.1);" />
</td>
...
<div align="right" style="margin-top:16px;">
  <a href="./Gruvbox_Deep_Light.json">
    <img src="https://img.shields.io/badge/Copy_Theme-FBF1C7?style=for-the-badge&logo=clipboard&logoColor=3C3836&labelColor=F2E5BC&color=F2E5BC&border=1" alt="Copy Light Theme" style="transition: transform 0.2s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'" />
  </a>
</div>
